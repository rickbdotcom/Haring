...
open class MarkdownCode: MarkdownCommonElement {
  ...
  open func addAttributes(_ attributedString: NSMutableAttributedString, range: NSRange) {
	...
	amendedAttributes[NSAttributedString.Key.backgroundColor] = UIColor(red: 0.91, green: 0.91, blue: 0.91, alpha: 1.0)
	amendedAttributes[NSAttributedString.Key.foregroundColor] = UIColor(red: 0.95, green: 0.25, blue: 0.44, alpha: 1.0)
	amendedAttributes[NSAttributedString.Key.font] = UIFont(name: "Menlo-Regular", size: 16)
